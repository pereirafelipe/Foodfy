module.exports = [
    ...
    {
      id: "torta",
      image: 'https://img.itdg.com.br/tdg/images/recipes/000/136/726/230822/230822_original.jpg?mode=crop&width=450&height=320',
      title: 'Torta do Frango do Chef',
      author: 'Felipe Pereira',
      ingredients: [
        '1/2 kg de peito de frango desfiado cozido;',
        '250 g de ricota ralada;',
        '150 g de azeitonas verdes picadas;',
        '100 g de queijo parmesão ralado;',
        '1 copo com 250 g de requeijão tradicional;',
        '1/2 kg de farinha de trigo1 colher (sopa) de fermento em pó;',
        '250 g de margarina (Qualy);',
        'opcionais: milho e ervilha;'
      ],
      preparation: [
        'Amasse com as mãos a farinha de trigo com a margarina até formar uma massa.',
        'Em uma frigideira, em fogo baixo, misture o frango cozido ao orégano e o sal.',
        'Misture a ricota e o requeijão ao frango e acrescente milho, ervilhas e as azeitonas verdes picadas.',
        'Desligue o fogo e reserve.',
        'Coloque a massa toda no marinex, preenchendo-a no vidro, cubra as bordas de massa até a metade, não deixe a massa espalhada grossa.',
        'Deixe no forno por 20 minutos no forno ou até dourar.'
      ],
      information: ''
    },
    {
      ...
      ingredients: [
        ...
        '2 embalagens de macarrão instantâneo;',
        '100 g de açúcar de confeiteiro;',
        '100 g de queijo parmesão ralado120 g pimentão sem pele e sem semente;',
        '16 g gengibre picado;',
        '200 g de folha de acelga;',
        '1 ovo cozido;',
        'pimenta-do-reino;',
      ...
      preparation: [
        'Coloque uma colher de sopa de azeite em uma panela e refoque o alho e o gengibre.',
        'Acrescente o shoyu e o o sake e deixe formar uma espécie de calda.',
        'Coe e reserve o molho.',
        'Tempere o Filezinho Sassami com sal e pimenta, aqueça uma frigideira com azeite e grelhe-o. Abaixe o fogo e coloque cerca de 100 ml de água e deixe cozinhar por 5 minutos.',
        'Cozinhe o macarrão de acordo com as instruções da embalagem.',
        'Sirva todos os ingredientes num prato fundo com meio ovo em cada prato e uma fatia de nori por cima.',
        'Acrescente também o Sassami de frango fatiado.'
    ...
    {
      id: "muffin",
      image: 'https://img.itdg.com.br/tdg/images/recipes/000/176/199/203646/203646_original.jpg?mode=crop&width=710&height=400',
      title: 'Muffin Salgado Royale',
      author: 'Robson Celoto',
      ingredients: [
      ...
      preparation: [
        'Rale as abobrinhas no ralador e coloque um pouco de sal, reserve.',
        'Pique a cebolinha e a cebola bem finos, reserve.',
        'Corte o presunto em cubos e reserve.',
        'Escorra a abobrinha com as mãos e acrescente a farinha de trigo..',
        'Misture o presunto, o milho verde, a cebola e a cebolinha.',
        'Coloque sal e pimenta-do-reino a gosto.',
        'Coloque em forminhas para muffin e decore com os tomates cereja.',
        'Asse em forno alto a 180ºC por 20 a 25 minutos.',
        'Teste com uma faca se o interior está assado.'
        
      ],
      information: ' Caso não tenha formas de muffin, pode-se usar uma forma quadrada normal untada com óleo e farinha, como se estivesse assando uma torta.'
    }
  ];